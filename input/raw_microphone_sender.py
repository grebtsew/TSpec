...
parser = argparse.ArgumentParser(
    description="Skicka mikrofonljud som raw IQ-float32 via UDP"
)
parser.add_argument(
    "--host",
    type=str,
...
parser.add_argument(
    "--samplerate", type=int, default=48000, help="Mikrofonens samplingsfrekvens [Hz]"
)
parser.add_argument(
...
def main():
    print(
        f"Skickar mikrofondata till {args.host}:{args.port} "
